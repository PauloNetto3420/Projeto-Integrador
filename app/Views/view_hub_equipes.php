...
<main class="content">
    <div class="container">
        ...
        <?php if (!$session->get('Id_Equipe')) : ?>
            ...
            <div class="mb-4">
                <a href="http://localhost/equipes/cadastrar" class="btn btn-primary">Criar Equipe</a>
                <a href="http://localhost/equipe/pesquisar" class="btn btn-primary">Procurar Equipes</a>
            </div>
        <?php else : ?>
